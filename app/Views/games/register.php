...
<div class="hero is-primary has-background-white-bis has-text-grey-dark">
    <div class="hero-body">
        <h1 class="title has-text-black">Registro de Jogo</h1>
        <h3 class="subtitle has-text-black">Descrição....</h3>

        <form class="box" action="<?php echo URLROOT;?>/Games/register" method="post">
            ...
            <div class="field">
                ...
                <div class="control">
                    <input name="time_adv" class="input" type="text" value="<?php echo $data["time_adv_casa"];?>">
                </div>
